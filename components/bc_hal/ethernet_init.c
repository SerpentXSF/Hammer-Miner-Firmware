...
#define CONFIG_EXAMPLE_ETH_SPI_MOSI_GPIO    21
#define CONFIG_EXAMPLE_ETH_SPI_MISO_GPIO    2
#define CONFIG_EXAMPLE_ETH_SPI_CS0_GPIO     10
#define CONFIG_EXAMPLE_ETH_SPI_INT0_GPIO    16
#define CONFIG_EXAMPLE_ETH_SPI_PHY_RST0_GPIO    13
#else  //ESP32-S3-ETH
#define CONFIG_EXAMPLE_ETH_SPI_SCLK_GPIO    13
#define CONFIG_EXAMPLE_ETH_SPI_MOSI_GPIO    11
#define CONFIG_EXAMPLE_ETH_SPI_MISO_GPIO    12
#define CONFIG_EXAMPLE_ETH_SPI_CS0_GPIO     14
